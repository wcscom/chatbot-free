...
## **<a href="https://open.kakao.com/o/sRGMJUHg" target="_blank">카카오톡 오픈 채팅 링크</a>**
---
#### name : 숙애의 채팅봇
#### version : 1.0.5 beta
...
---
## **❤️⭐도와주신분들⭐❤️ <br style="margin-bottom:10px;"/>BJ다냥이ღ - BJ채민❤️ - BJ순수하양ღ - ✦쑤야✦ - ღ지히ღ - 이나❤️<br/>❤️소영❤️ - BJ나라❤️ - 아키✿ - BJ✿ܓⓊⓅ해쥬ഒ - ෆ마찌ෆ**
---
#### ⭐처음 세팅하시면, 어려울 수 있어요! 차분하게 읽어보시구~ 영문 번역을 해제해주세요!
---
## ⭐요청 업데이트 예정 (일에 치여서 업데이트 느려요..)
### 명령어 사용자 레벨 구분
### 채팅 도배 매크로 (리액션 중 반복매크로)
### 갑자기 관리자 권한 필요해짐 
(로그인안되는 문제 해결하려고 개발자 싸인없는 컴으로 
급히 수정하다보니 빌드때 싸인 못했습니다. 
무시하고 그냥 실행하면됩니다.)
---
## ⭐요청 업데이트 완료 (베타버전은 다시 다운로드 및 설치해야합니다~)
### 입장시 자동 채팅 삭제
### 고정 응답 20분 -> 1시간이상으로 변경
### 브압, 열혈, 회장 입장 자동 응답
### 명령어 및 자동 응답 체크박스로 사용 추가
### 로또 추첨 번호 확인 및 생성 ex)!로또 -> 당첨번호확인 / !로또 생성 -> 번호 생성
### 오늘의 운세 추가 ex) !오늘 90
### 시청자, 하트, 채팅 내역을 드래그시 복사 가능하게 하기
### 종료시 Temp 디렉토리 임시파일 삭제 안되던 문제
### 인증코드 사용자용 게스트넣기 추가
### 간헐적 랑비 이후 팅김 현상, 명령어 3번 중복 응답 에러 수정 완료
### 시청자수 늘리기 ex) 게스트1~22개 ( 인증코드 활성화 완료 ) 
### 크롬 129.0 버전인경우, 흰색 창이 나오는 문제 ( 무시하고 쓰시는데는 지장없음, 구글 크롬 chromium 버그입니다. 프로그램과 상관없음 )
### 오늘 뿐만아니라, 내일 운세 추가
### 팬더 로그인 중복으로 인한, 로그인 로직 변경
### 광고 나오는시간 1시간20분에서 3시간40분마다로 변경
---
## ❤️⭐ 필독! - 무료 배포 프로그램이라 경고뜹니다. 무시하고 진행하세요.⭐❤️
### ⭐ 설치시, 윈도우 보안 파란색 창 뜰 수 있습니다! 이럴경우.
...
### ⭐<br/> 보안알림 뜨는 이유는 배포용 윈도우 디지털라이센스를 구매안해서입니다. <br/> 이 라이센스 구매에는 비용과 기간 제한이 존재해서 그래요. <br/> 소규모 무료용은 이렇습니다~윈도우 돈놀음이에요..<br/> 물론 해킹, 바이러스 전혀 상관없습니다 <br/> 애플 맥os를 사용할경우! 애플 개발자로 등록되어있는 상태라 맥용으로 따로 드릴 수 있습니다😊 <br/>만약 특정 인원 이상 설치할 경우, 마이크로소프트에서 정상 앱으로 인식하게 됩니다. (리퓨테이션구축)
...
### <a href="https://drive.google.com/file/d/1T_se0JFaqtOXtkzTFMtti8zAv7CCoo2U/view?usp=drive_link" target="_blank">🔗 [다운로드 링크 (구글 드라이브)]</a>
---
...
<img src="https://github.com/wcscom/chatbot-free/assets/168957756/b8f4c1f8-e529-42e6-a156-e29821b1ef6b" width="300">
...
3. **PC가 아닌 모바일 앱으로도 제작 가능합니다! 의뢰 주실 괴큰손 옵빠는 연락주세유😍**
4. **해킹,바이러스없어여! 진짜 걱정안하셔도 됩니다.**
5. **라이센스 구입되지 않은 프로그램이기에 일부 os환경에서 관리자 권환으로 실행해야할 수 있습니다.**
6. **채팅 메크로 기능은 귀찮아서 아직 안넣었습니다~ 요청주시면 넣어볼게요.**
