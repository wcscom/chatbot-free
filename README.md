...
### 시청자수 늘리기 ex) 게스트5~10 접속, (리소스모니터링 및 보안테스트중) 
### 로또 추첨 완료 번호 확인 및 로또 생성 ex)!로또 ->당첨번호확인 / !로또 생성 -> 번호 생성
### 타로 운세 ( 22장중 선택) ex)!타로 12 -> 데일리 타로운세 12번카드 -> 운세 전달 
### 명령어 사용자 레벨 구분
### 채팅 도배 매크로 (리액션 중 반복매크로)
### 수개봇1~30개 활용 추천30개 누르기(계정 만들면 업로드함...)
---
## ⭐요청 업데이트 완료 (베타버전은 다시 다운로드 및 설치해야합니다~)
### 입장시 자동 채팅 삭제
### 고정 응답 20분 -> 1시간 변경
### 브압, 열혈, 회장 입장 자동 응답 (브압은 테스트못해서 안될수있음. 그냥쓰셈....)
### 명령어 및 자동 응답 체크박스로 사용 추가
### 1.01v 에러 업데이트 -> ෆ마찌ෆ 제보 
...
### <a href="https://drive.google.com/file/d/1hkXNvPg5KKgwWn7EcGDZLhoi5laHd0T4/view?usp=drive_link" target="_blank">🔗 [다운로드 링크 (구글 드라이브)]</a>
---
